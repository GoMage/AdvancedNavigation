...
class GoMage_Navigation_Model_Adminhtml_System_Config_Source_Filter_Type_Category{
    ...
    public function toOptionArray(){
        ...
        return array(
            ...
            array('value'=>GoMage_Navigation_Model_Layer::FILTER_TYPE_DEFAULT_PRO, 'label' => $helper->__('Default (Pro)')),
    ...
    public function toOptionHash(){
        ...
        return array(
            ...
            GoMage_Navigation_Model_Layer::FILTER_TYPE_DEFAULT_PRO	=> $helper->__('Default (Pro)'),
