 ...
 */
class GoMage_Navigation_Model_Enterprise_Search_Catalog_Layer extends Enterprise_Search_Model_Catalog_Layer
{	
    ...
    public function getAttributeOptionsImages($attribute_id)
    {
        if (is_null($this->attribute_options_images)) {
            ...
            foreach ($options as $option) {
                ...
                $this->attribute_options_images[$option->getData('attribute_id')][$option->getData('option_id')] = $option->getData('filename');
            }
        }
