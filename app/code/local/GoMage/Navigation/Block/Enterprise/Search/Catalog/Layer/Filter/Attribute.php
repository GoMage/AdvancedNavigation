 ...
 */
class GoMage_Navigation_Block_Enterprise_Search_Catalog_Layer_Filter_Attribute extends Enterprise_Search_Block_Catalog_Layer_Filter_Attribute
{		
	/**
     * Set model name
     */
    ...
    {		
        ...
        $this->_filterModelName = 'gomage_navigation/enterprise_search_catalog_layer_filter_attribute';
    }
