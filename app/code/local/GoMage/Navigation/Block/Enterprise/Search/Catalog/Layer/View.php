 ...
 */
class GoMage_Navigation_Block_Enterprise_Search_Catalog_Layer_View extends Enterprise_Search_Block_Catalog_Layer_View
{
    protected $GMN	= null;
    ...
    protected function _initBlocks()
    {
        ...
        if (Mage::helper('enterprise_search')->getIsEngineAvailableForNavigation()) {
            $this->_categoryBlockName			= 'gomage_navigation/enterprise_search_catalog_layer_filter_category';
            $this->_attributeFilterBlockName	= 'gomage_navigation/enterprise_search_catalog_layer_filter_attribute';
            $this->_priceFilterBlockName		= 'gomage_navigation/enterprise_search_catalog_layer_filter_price';
            $this->_decimalFilterBlockName		= 'gomage_navigation/enterprise_search_catalog_layer_filter_decimal';
			$this->_stockFilterBlockName		= 'gomage_navigation/enterprise_search_catalog_layer_filter_stock';
        } else {	
    ...
    */
    protected function _prepareLayout()
    {
		...
		switch ($shopby_position) {
			case GoMage_Navigation_Model_Adminhtml_System_Config_Source_Shopby::CONTENT :
				$blocks['gomage.enterprisecatalog.content']	= $this->getLayout()->getBlock('content');
			break;
			...
			case GoMage_Navigation_Model_Adminhtml_System_Config_Source_Shopby::RIGHT_COLUMN :
				$blocks['gomage.enterprisecatalog.right']	= $this->getLayout()->getBlock('right');
			break;
    ...
    public function getLayer()
    {
        ...
        if (Mage::helper('enterprise_search')->getIsEngineAvailableForNavigation()) {
            return Mage::getSingleton('gomage_navigation/enterprise_search_catalog_layer');
        }
